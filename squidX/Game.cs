...
namespace Xbox360Game
{
    public class Game : Microsoft.Xna.Framework.Game
    {
        ...
        public Color fontColor = new Color(Color.WhiteSmoke, 160);
        public int score=0;
        ...
        public static Random randy = new Random(459364);
        ...
        public Highscores2.Storage store;

        public static Texture2D linePixel;
        public List<Text> events = new List<Text>();
    ...
    int gametypeFilter = -1;
        ...
        public Game()
        {
            ...
            //graphics.PreparingDeviceSettings += new EventHandler<PreparingDeviceSettingsEventArgs>(eliminatePurple);

        }
        

        void eliminatePurple(object sender, PreparingDeviceSettingsEventArgs eventargs) //eliminates purple
        {
     ...
     * on, and probably won't be part of a real game.
        ...
        protected override void LoadContent()
        {
            ...
            themeSong = Content.Load<Song>("150510_drum_and_blues_1");
            ...
            //Line texture
            linePixel = new Texture2D(device, 1, 1, 1, TextureUsage.None, SurfaceFormat.Color);
        ...
        {  
            ...
            store.AddHighscore(new Highscores2.Highscore(PlayerIndex.One,score),false);
        ...
        protected override void Update(GameTime gameTime)
        {
           ...
           // if (GamePad.GetState(PlayerIndex.One).IsButtonDown(Buttons.Y)) this.clearScore();
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin(SpriteBlendMode.AlphaBlend, SpriteSortMode.Deferred, SaveStateMode.None, cam.Transform);
            //saveScore();
            if (st == state.splash)
            {
            ...
            else
            {
                ...
                else if (st == state.gameOver)
                {
                    ...
                    spriteBatch.DrawString(font, "Score: " + score, new Vector2(400, 300), Color.Red);
                    if (counter == 100)
                    {
